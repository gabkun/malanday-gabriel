...
import AddClassroomModal from "../Modals/AddClassroom";

const Classroom = () => {
    const [isAddClassroomModalOpen, setIsAddClassroomModalOpen] = useState(false);

    const openModal = () => setIsAddClassroomModalOpen(true);
    const closeModal = () => setIsAddClassroomModalOpen(false);
  ...
  return (
    <div className="flex h-screen">
      ...
      {/* Modal Integration */}
      <AddClassroomModal isOpen={isAddClassroomModalOpen} onClose={closeModal} />
      {/* Main Content */}
      <div className="flex-grow bg-gray-100 p-6 overflow-auto">
        <h1 className="text-2xl font-bold mb-6">Classroom Dashboard</h1>
        <button
        onClick={openModal}
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 px-4 sm:grid-cols-4">
          ...
          <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
              <h3 className="text-sm tracking-wider">Total Classrooms</h3>
