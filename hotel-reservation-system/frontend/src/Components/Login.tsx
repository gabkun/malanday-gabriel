...
import axiosInstance from '../../api/axiosConfig'; // Ensure AxiosInstance is set up correctly
...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userId = response?.data?.user?.id; // Access the userId inside the user object
      const role = response?.data?.user?.role; // Access the role inside the user object
